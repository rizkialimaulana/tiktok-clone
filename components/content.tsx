            ...
            <div className='flex space-x-4 items-start justify-between'>
                <div className='flex items-start space-x-3'>
                    ...
                    <div className='flex flex-col space-y-2'>
                        <h1 className='font-bold text-lg cursor-pointer'>Account Name{"  "}<span className='font-thin'>Name</span></h1>
                        <p className='text-sm'>Could anyone explain this?</p>
                        <div className='flex items-center space-x-2'>
                            <span className='font-bold text-md cursor-pointer'>#Lol</span>
                            <span className='font-bold text-md cursor-pointer'>#Lol</span>
                            <span className='font-bold text-md cursor-pointer'>#Lol</span>
                        </div>
                        <div className='flex space-x-3 items-end'>
                            ...
                            <div className='flex flex-col items-center space-y-4'>
                                <div className='flex flex-col items-center space-y-3'>
                                    <FcLike className='w-6 h-auto md:w-8 md:h-8 cursor-pointer'/>
                                    <span className='font-bold text-xs'>1K</span>
                                </div>
                                <div className='flex flex-col items-center space-y-3'>
                                    <FaRegCommentDots className='w-6 h-auto md:w-8 md:h-auto cursor-pointer'/>
                                    <span className='font-bold text-xs'>1.950</span>
                                </div>
                                <div className='flex flex-col items-center space-y-3'>
                                    <IoMdShareAlt className='w-6 h-auto md:w-8 md:h-8 cursor-pointer'/>
